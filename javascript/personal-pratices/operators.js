...
// 11. Check Even and Odd

let numberValue = 7;
let checkedNumber = numberValue % 2 == 0 ? "Even" : "odd";
console.log(checkedNumber);

// 12. Vote Eligibility
const age = 26;
let CheckEligibility = age >= 18 ? "You can vote" : "You Can't able to Vote";
console.log(CheckEligibility);

// 13. check  positive or negative integer

let integerNumber = -3;
let integerType = integerNumber > 0 ? "Positive Number" : "Negative Number";
